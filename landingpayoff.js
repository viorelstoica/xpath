...
for (let i = 0; i < nodes.length; i++) {
  ...
  let payoffBillId = select("../c:recaccountdetails/f:actBillDetails[f:billType = 'PAYOFF']/f:billId", n)
  if(payoffBillId.length > 0)
    payoffBillId = payoffBillId[0].firstChild.data  
